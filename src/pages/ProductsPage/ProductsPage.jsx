...
import { Header, MainContainer, WrapperCardStyle, StyleNameProduct, WrapperReportText, WrapperPriceText, WrapperDiscountText, BrandMenuStyle, FilterByNeedStyle, FilterByCriteriaStyle, BannerStyle } from './style'; // Import styled components
